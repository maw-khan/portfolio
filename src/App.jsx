...
const projects = [
  ...
  },
  {
    ...
    gallery: [
      ...
      "/projects/hr/workforce_analysis.png",
      "/projects/hr/performance.png",
      "/projects/hr/power_query.png",
    ],

    stack: ["Power BI", "Power Query", "DAX", "Data Modeling"],

    flow:
      "HR Data → Power Query → Data Modeling → DAX Measures → Interactive Visualizations → Workforce Insights",
